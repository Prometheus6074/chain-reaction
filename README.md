...
The Normal AI uses a minimax algorithm with a search depth of 1–2 moves. Hard AI searches 3–4 moves deep with alpha-beta pruning for noticeably stronger play. Both difficulty levels scale their search depth automatically based on grid size to remain responsive.
...
A built-in MIDI music player powered by SpessaSynth provides a 15-track soundtrack. Controls include previous, play/pause, next, a volume slider, and a seek bar. The player repositions itself contextually between the setup screen, online lobby, and in-game view.
...
| SpessaSynth (ESM via jsDelivr) | In-browser MIDI synthesis |
...
MIDI arrangements by [tutogamer2a](https://musescore.com/user/29606600/scores).
